...
public abstract class ControllerDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            controllerDao.insert(new Controller("AuthCtrlr","Enabled", MutabilityEnumType.ReadWrite.toString(),"", DataEnumType.Boolean.toString(),"",""));
            ...
            controllerDao.insert(new Controller("SecurityCtrlr","CertificateEntries", MutabilityEnumType.ReadOnly.toString(),"", DataEnumType.integer.toString(),"",""));
            ...
            controllerDao.insert(new Controller("TariffCostCtrlr","Currency", MutabilityEnumType.ReadWrite.toString(),"", DataEnumType.string.toString(),"",""));
